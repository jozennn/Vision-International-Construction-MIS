...
Route::middleware('auth:sanctum')->group(function () {
    ...
    // --- ENGINEERING & LEADS ---
    // Add this inside your auth:sanctum group
    Route::get('/engineering/dashboard-stats', [App\Http\Controllers\EngineeringController::class, 'getDashboardStats']);
    // Head Engineer assigning a team to a project
    Route::post('/engineering/assign-task', [EngineeringController::class, 'assignTask']);
    // Regular Engineer claiming a project from the queue
    Route::post('/engineering/pick-project', [EngineeringController::class, 'pickProject']);
